...
public class AtravessarRua {
	...
	static {
		...
		POSSIVEISENTRADAUSUARIONAO.add("não");
		...
		do {
			...
			do {
				...
				if (jaFoiDireita && jaFoiEsquerda) {
					System.out.println("VOCÊ CONSEGUIU ATRAVESSAR A RUA COM SUCESSO !!!!");
				...
				switch (atravessarRua.getDireitaOuEsquerda()){
						...
						if(olharDireita) {
							if(carro > 0) {
								...
								if(passo.equalsIgnoreCase("P")) {
									System.out.println("Andando para frente....");
									System.out.println("Você andou no momento que o carro estava vindo");
								} else {
								...
								System.out.println("Não esta vindo carro ");
								System.out.print("Deseja dar mais um passo? Digite A(aguardar) ou P(para dar um passo)");
								passo = in.next();
								...
								if(passo.equalsIgnoreCase("P")) {
									...
									System.out.println("Você ficou parado na faixa e um carro te atropelou");
								}
							}
						}
					break;
					...
					default:
						System.out.println("Valor não localizado e você foi atropelado");
					break;
				}
			...
			System.out.println("====================================");
			System.out.print("Deseja continuar jogando? S(Sim) e (N)Não: ");
